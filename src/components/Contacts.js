                ...
                <div className= 'downmovers' style={{marginTop:'20px', marginBottom:'20px'}}>
                    <span style={{marginRight:'0.5%'}}>
                        ...
                        style={
                            ...
                            >
                            <svg viewBox="0 0 64 64" style={{ width:'56px', height:'56px', backgroundColor:'#F5F5F5'}}>
                    ...
                    <a 
                        ...
                        style={
                            ...
                            href='https://open.spotify.com/playlist/24UsN45jfHwYkqtKKt9hwG?si=GY2Fh68jSqG3HnyuMEnlAA'
                            >
                                <span>
                                    <svg viewBox="0 0 64 64" style={{width:'56px', height:'56px', backgroundColor:'#f5f5f5'}}>
